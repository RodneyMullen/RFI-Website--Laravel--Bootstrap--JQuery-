...
@section('title')
<title>Add Practitioner Listing  </title>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-8">
        <div class="wrapper">
            <h1>Add Practitioner Listing </h1>
...
<div class="row">
 ...
 <form action="{{route('practitionerListingPersist')}}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="listing_name" type="text" class="form-control" name="listing_name" value="{{ old('listing_name')}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="listing_website" type="text" class="form-control" name="listing_website" value="{{ old('listing_website')}}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            ...
            <textarea class="form-control rounded-0" id="listing_notes" name="listing_notes" rows="10">{{ old('listing_notes')}}</textarea>
        </div>
    </div>
     ...
     <div class="form-group row">
        ...
        <div class="col-md-2 offset-md-2">
            <button type="submit" id="delete_practitioner_listing" name="delete_practitioner_listing" value="Delete" > Delete Listing</button>
        </div>
